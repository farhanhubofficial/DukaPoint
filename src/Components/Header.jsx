...
function Header() {
  ...
  return (
    <nav className="flex items-center justify-between w-screen px-3 relative bg-white bg-opacity-90 border-b shadow-md font-[poppins]">
...
{isSideMenuOpen && (
  <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex">
    <div className="bg-white w-64 h-full p-4 mt-2 border border-gray-300 shadow-lg rounded-lg">
      <IoMdClose className="text-3xl mb-4" onClick={() => setMenu(false)} />
      <ul className="space-y-6 font-bold text-yellow-800/100"> {/* Increased space-y-4 to space-y-6 */}
        <li>
